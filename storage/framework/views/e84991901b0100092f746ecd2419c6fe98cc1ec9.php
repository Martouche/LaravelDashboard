...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Venturi Dashboard')); ?></title>
        <!-- Favicon -->
  ...
  headers: {
    ...
    $('#session').change(function(){
        ...
        $.ajax({
            url: '<?php echo e(route('runsheetgetsession')); ?>',
            type: "POST",
            data: {
    ...
    $('#season').change(function(){
        $.ajax({
            url: '<?php echo e(route('runsheetgetseason')); ?>',
            type: "POST",
            data: {
    ...
    $('#event').change(function(){
        $.ajax({
            url: '<?php echo e(route('runsheetgetevent')); ?>',
            type: "POST",
            data: {
    ...
    $('#driver').change(function(){
        $.ajax({
            url: '<?php echo e(route('runsheetgetdriver')); ?>',
            type: "POST",
            data: {
...
<?php /**PATH /home/mvantalon/Projects/venturi-dashboard/resources/views/layouts/app.blade.php ENDPATH**/ ?>