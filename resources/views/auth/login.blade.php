@extends('layouts.app', ['class' => 'login-page', 'page' => __('Page de connexion'), 'contentClass' => 'login-page'])
               ...
               <br>
                ...
                <div class="card-body">
                    ...
                    <div class="input-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                        ...
                        <input type="password" placeholder="{{ __('Password') }}" name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" autocomplete="on">
